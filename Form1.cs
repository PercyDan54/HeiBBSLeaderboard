...
namespace HeiBBSLeaderboard
{
    public partial class Form1 : Form
    {
        ...
        {
            var document = SoftCircuits.HtmlMonkey.HtmlDocument.FromHtml(GetResponse($"https://www.heibbs.net/?{uid}"));
            ...
            var timespan = (DateTime.Now - regDate).Days;
        ...
        private void button1_Click(object sender, EventArgs args)
        {
            ...
            try
            {
                jsonText = GetResponse($"https://www.heibbs.net/api/get_credits.php?start={startInt}&end={endInt}");
